...
if __name__ == "__main__":
    ...
    print(first_missing_positive_integer_unsorted_On([0, 1,2])
    
    print("\nTest 2: [1,0,3,4] - should be: 2")
    print(first_missing_positive_integer_unsorted_On([1,0,3,4])
    
    print("\nTest 3: [8, 9, 1, 2, 3, 4, 5, 7, 0] \n- should be: 6")
    print(first_missing_positive_integer_unsorted_On([8, 9, 1, 2, 3, 4, 5, 7, 0])
    
    print("\nTest 4: [11, 14, 2, 3, 12, 4, 1, 5, 6, 7, 8, 9, 10, 0, 15] \n- should be: 13")
    print(first_missing_positive_integer_unsorted_On([11, 14, 2, 3, 12, 4, 1, 5, 6, 7, 8, 9, 10, 0, 15])
